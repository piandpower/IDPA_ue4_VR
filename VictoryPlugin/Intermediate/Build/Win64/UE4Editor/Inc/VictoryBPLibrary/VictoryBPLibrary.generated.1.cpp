...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_ESpeedUnit(ESpeedUnit_StaticEnum, TEXT("/Script/VictoryBPLibrary"), TEXT("ESpeedUnit"), false, nullptr, nullptr);
	...
	IMPLEMENT_CLASS(AVictoryISM, 1369047241);
...
static struct FScriptStruct_VictoryBPLibrary_StaticRegisterNativesFVictoryInput
{
	...
	IMPLEMENT_CLASS(UVictoryBPFunctionLibrary, 2873013970);
...
static struct FScriptStruct_VictoryBPLibrary_StaticRegisterNativesFVictorySubtitleCue
{
	...
	IMPLEMENT_CLASS(AVictoryPC, 514973063);
	...
	IMPLEMENT_CLASS(UVictoryTMapComp, 3307878367);
...
// Cross Module References
	...
	UEnum* Z_Construct_UEnum_VictoryBPLibrary_ESpeedUnit()
	{
		...
		if (!ReturnEnum)
		{
			...
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("CentimeterPerSecond")), 0));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FootPerSecond")), 1));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("MeterPerSecond")), 2));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("MeterPerMinute")), 3));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("KilometerPerSecond")), 4));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("KilometerPerMinute")), 5));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("KilometerPerHour")), 6));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("MilePerHour")), 7));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("Knot")), 8));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("Mach")), 9));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("SpeedOfLight")), 10));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("YardPerSecond")), 11));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("ESpeedUnit_MAX")), 12));
	...
	uint32 Get_Z_Construct_UEnum_VictoryBPLibrary_ESpeedUnit_CRC() { return 4273777775U; }
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
	...
	UEnum* Z_Construct_UEnum_VictoryBPLibrary_EJoyGraphicsFullScreen()
	{
		...
		if (!ReturnEnum)
		{
			...
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EJoyGraphicsFullScreen::FullScreen")), 0));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EJoyGraphicsFullScreen::WindowedFullScreen")), 1));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EJoyGraphicsFullScreen::WindowedFullScreenPerformance")), 2));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EJoyGraphicsFullScreen::EJoyGraphicsFullScreen_Max")), 3));
	...
	uint32 Get_Z_Construct_UEnum_VictoryBPLibrary_EJoyGraphicsFullScreen_CRC() { return 4149546311U; }
	UEnum* Z_Construct_UEnum_VictoryBPLibrary_EVictoryHMDDevice()
	{
		...
		if (!ReturnEnum)
		{
			...
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EVictoryHMDDevice::None")), 0));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EVictoryHMDDevice::OculusRift")), 1));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EVictoryHMDDevice::Morpheus")), 2));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EVictoryHMDDevice::ES2GenericStereoMesh")), 3));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EVictoryHMDDevice::SteamVR")), 4));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EVictoryHMDDevice::GearVR")), 5));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EVictoryHMDDevice::EVictoryHMDDevice_MAX")), 6));
	...
	uint32 Get_Z_Construct_UEnum_VictoryBPLibrary_EVictoryHMDDevice_CRC() { return 4236981099U; }
	UEnum* Z_Construct_UEnum_VictoryBPLibrary_EJoyImageFormats()
	{
		...
		if (!ReturnEnum)
		{
			...
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EJoyImageFormats::JPG")), 0));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EJoyImageFormats::PNG")), 1));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EJoyImageFormats::BMP")), 2));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EJoyImageFormats::ICO")), 3));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EJoyImageFormats::EXR")), 4));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EJoyImageFormats::ICNS")), 5));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EJoyImageFormats::EJoyImageFormats_MAX")), 6));
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::EnumClass);
	...
	uint32 Get_Z_Construct_UEnum_VictoryBPLibrary_EJoyImageFormats_CRC() { return 3028379287U; }
	...
	UClass* Z_Construct_UClass_UVictoryBPFunctionLibrary()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UVictoryBPFunctionLibrary_GetHeadMountedDisplayDeviceType(), "GetHeadMountedDisplayDeviceType"); // 2302410308
				...
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UVictoryBPFunctionLibrary_Victory_LoadTexture2D_FromFile(), "Victory_LoadTexture2D_FromFile"); // 267630395
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UVictoryBPFunctionLibrary_Victory_LoadTexture2D_FromFile_Pixels(), "Victory_LoadTexture2D_FromFile_Pixels"); // 3299667313
